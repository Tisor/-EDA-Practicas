...
abstract public class AbstractHashTableMap<K, V> implements Map<K, V> {
    ...
    protected HashEntryIndex findEntry(K key) throws IllegalStateException {
        ...
        int i = hashValue(key);
        final int j = i;
        // Para realizar el offset se necesita saber el intento en el que se encuentra
        //el algoritmo, se ha añadido una nueva variable que indica el intento
        //para pasarlo al metodo offset.
        int counter = 1;
        do {
            ...
            i = (i + offset(key,counter)) % capacity; // keep looking
